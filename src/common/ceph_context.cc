  ...
  bufferlist *out)
{
  ...
  else if (command == "perfcounters_schema_labeled" || command == "3" ||
      command == "perf schema labeled") {
    ...
    crush_location(this)
{
  ...
  _admin_socket->register_command("perf schema labeled", _admin_hook, "dump labeled perfcounters schema");
