...
TEST(PerfCountersCache, NoCacheTest) {
  ...
  std::string message;
  ASSERT_EQ("", client.do_request("{ \"prefix\": \"perf dump labeled\" }", &message));
  ASSERT_EQ("{}\n", message);
  ASSERT_EQ("", client.do_request("{ \"prefix\": \"perf schema labeled\" }", &message));
  ASSERT_EQ("{}\n", message);
}
...
TEST(PerfCountersCache, TestEviction) {
  ...
  ASSERT_EQ("", client.do_request("{ \"prefix\": \"perf schema labeled\", \"format\": \"json\" }", &message));
  ASSERT_EQ("{\"key1\":{\"labels\":{\"label1\":\"val1\"}},\"key2\":{\"labels\":{\"label2\":\"val2\"}},\"key3\":{\"labels\":{\"label3\":\"val3\"}},\"key4\":{\"labels\":{\"label4\":\"val4\"}}}", message);
...
TEST(PerfCountersCache, TestLabelStrings) {
  ...
  ASSERT_EQ("", client.do_request("{ \"prefix\": \"perf dump labeled\", \"format\": \"json\" }", &message));
  ASSERT_EQ("{\"bad_ctrs1\":{\"labels\":{\"label1\":\"\",\"label3\":\"val4\"},\"test_counter\":2},\"bad_ctrs2\":{\"labels\":{\"label1\":\"val1\"},\"test_counter\":2},\"good_ctrs\":{\"labels\":{\"label2\":\"val4\",\"label3\":\"val3\"},\"test_counter\":8}}", message);
  ...
  ASSERT_EQ("", client.do_request("{ \"prefix\": \"perf dump labeled\", \"format\": \"json\" }", &message));
  ASSERT_EQ("{\"bad_ctrs1\":{\"labels\":{\"label1\":\"\",\"label3\":\"val4\"},\"test_counter\":2},\"bad_ctrs2\":{\"labels\":{\"label1\":\"val1\"},\"test_counter\":2},\"good_ctrs\":{\"labels\":{\"label2\":\"val4\",\"label3\":\"val3\"},\"test_counter\":8},\"too_many_delimiters\":{\"labels\":{\"label1\":\"val1\"}}}", message);
